...
const Home = () => {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative flex flex-col justify-between pt-20 pb-8 min-h-screen max-w-7xl mx-auto w-full overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-10 flex flex-col items-center justify-center flex-grow px-4 sm:px-6 lg:px-8 text-center animate-fade-in-up">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface/80 border border-white/10 backdrop-blur-md mb-6 animate-float">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-accent-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-accent-500"></span>
                </span>
                <span className="text-xs font-mono text-secondary tracking-wide">SYSTEM ONLINE v2.5</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up [animation-delay:400ms] mb-8">
